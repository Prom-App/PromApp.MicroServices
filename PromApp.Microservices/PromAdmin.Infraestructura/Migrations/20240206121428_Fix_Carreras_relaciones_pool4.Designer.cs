...
namespace PromAdmin.Infraestructura.Migrations
{
    ...
    [Migration("20240206121428_Fix_Carreras_relaciones_pool4")]
    partial class Fix_Carreras_relaciones_pool4
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PromAdmin.Dominio.Entidades.Actitud", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("NombreActitud")
                        .HasColumnType("nvarchar(450)");

                    b.HasKey("Id");

                    b.HasIndex("NombreActitud")
                        .IsUnique()
                        .HasFilter("[NombreActitud] IS NOT NULL");

                    b.ToTable("Actitud", (string)null);
                });

            modelBuilder.Entity("PromAdmin.Dominio.Entidades.ActitudXCarrera", b =>
                {
                    b.Property<int>("IdActitud")
                        .HasColumnType("int");
                    ...
                    b.ToTable("ActitudesXCarrera", (string)null);
                });
            ...
            modelBuilder.Entity("PromAdmin.Dominio.Entidades.CarreraEvitarXPersonalidad", b =>
                {
                    ...
                    b.HasKey("IdPersonalidad", "IdCarrera");

                    b.HasIndex("IdCarrera");

                    b.ToTable("CarrerasEvitar", (string)null);
                });

            modelBuilder.Entity("PromAdmin.Dominio.Entidades.CarreraFuturoXPersonalidad", b =>
                {
                    b.Property<int>("IdPersonalidad")
                        .HasColumnType("int");
                    ...
                    b.ToTable("CarrerasFuturo", (string)null);
                });

            modelBuilder.Entity("PromAdmin.Dominio.Entidades.CarreraRecomendadaXPersonalidad", b =>
                {
                    b.Property<int>("IdPersonalidad")
                        .HasColumnType("int");
                    ...
                    b.ToTable("CarrerasRecomendadas", (string)null);
                });
            ...
            modelBuilder.Entity("PromAdmin.Dominio.Entidades.Habilidad", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("NombreHabilidad")
                        .IsUnique()
                        .HasFilter("[NombreHabilidad] IS NOT NULL");
            ...
            modelBuilder.Entity("PromAdmin.Dominio.Entidades.HabilidadXCarrera", b =>
                {
                    ...
                    b.ToTable("HabilidadesXCarrera", (string)null);
                });
            ...
            modelBuilder.Entity("PromAdmin.Dominio.Entidades.Interes", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("NombreInteres")
                        .HasColumnType("nvarchar(450)");

                    b.HasKey("Id");

                    b.HasIndex("NombreInteres")
                        .IsUnique()
                        .HasFilter("[NombreInteres] IS NOT NULL");
            ...
            modelBuilder.Entity("PromAdmin.Dominio.Entidades.MBTIResultado", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("Judging")
                        .HasColumnType("int");

                    b.Property<string>("ModificadoPor")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("Perceiving")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PromAdmin.Dominio.Entidades.Personalidad", b =>
                {
                    ...
                    b.Property<string>("Recomendadas")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("PromAdmin.Dominio.Entidades.Pregunta", b =>
                {
                    ...
                    b.Property<string>("AyudaGrafica")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("PromAdmin.Dominio.Entidades.ActitudXCarrera", b =>
                {
                    b.HasOne("PromAdmin.Dominio.Entidades.Carrera", null)
            ...
            modelBuilder.Entity("PromAdmin.Dominio.Entidades.Habilidad", b =>
                {
                    b.Navigation("HabilidadesXCarreras");
                });

            modelBuilder.Entity("PromAdmin.Dominio.Entidades.Interes", b =>
                {
                    b.Navigation("InteresesXCarrera");
                });
